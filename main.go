...
func init() {
	...
	// 网关: 获取网关地址和版本信息
	packets.RegisterPacketHandler(10996, []packets.PacketHandler{answer.Forge10996})
	// 网关: 用户登录
	packets.RegisterPacketHandler(10020, []packets.PacketHandler{answer.Forge10020})

	// 游戏服务器: 用户登录
	packets.RegisterPacketHandler(10022, []packets.PacketHandler{answer.Game10022})
